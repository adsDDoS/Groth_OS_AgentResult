...
:80 {
  ...
  @demoOptions {
    method OPTIONS
    path /health /me /offer /demand-map /approvals /agents /analytics/overview /publication-results /distribution-signals /result-signals /owner-action-audit /content/items /publishing/calendar /workspace/state /tasks
  }
  handle @demoOptions {
